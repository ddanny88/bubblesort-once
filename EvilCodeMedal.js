...
function evilCodeMedal(gold, silver, bronze, userTime){
    if(userTime < gold){
      return "Gold";
  ...
  /*evilCodeMedal(gold = "00:15:00",
   silver = "00:45:00",  bronze = "01:15:00", userTime = "00:30:00");
  
  evilCodeMedal(gold = "00:15:00",
   silver = "00:45:00", bronze = "01:15:00", userTime = "01:15:00");
   */